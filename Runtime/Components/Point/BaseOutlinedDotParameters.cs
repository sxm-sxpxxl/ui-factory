...
{
    public abstract class BaseOutlinedDotParameters : BaseDotParameters
    {
        public float Size;
        public BaseLineParameters LineParameters;

        protected BaseOutlinedDotParameters()
        {
        }

        protected BaseOutlinedDotParameters(Dictionary<string, object> rawParameters) : base(rawParameters)
        {
        ...
        protected override bool Equals(MeshParameters other)
        {
            ...
            var obj = other.CastTo<BaseOutlinedDotParameters>();
